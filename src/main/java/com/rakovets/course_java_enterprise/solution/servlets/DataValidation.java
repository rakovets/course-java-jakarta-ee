...
import com.rakovets.course_java_enterprise.solution.entity.ArtistDto;
...
public class DataValidation extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if(req.getParameter("name").length() == 0 || req.getParameter("option") == null) {
            ...
            ArrayList artistsList = com.rakovets.course_java_enterprise.solution.instanceObject.InstanceObject.getInstanceArtistsList();
